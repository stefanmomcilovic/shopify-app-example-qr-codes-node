...
export function QRCodeForm({ QRCode: InitalQRCode }) {
    const [QRCode, setQRCode] = useState(InitalQRCode);
    ...
    */
    ...
    const QRCodeURL = QRCode ? new URL(`/qrcodes/${QRCode.id}/image`, location.toString()) : null;
